module.exports = [
"[project]/node_modules/music-metadata/lib/riff/RiffChunk.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Header = {
    ...
    get: (buf, off)=>{
        return {
            // Group-ID
            chunkID: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StringType"](4, 'latin1').get(buf, off),
            // Size
            chunkSize: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_LE"].get(buf, off + 4)
        };
    }
};
class ListInfoTagValue {
    ...
    get(buf, off) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StringType"](this.tagHeader.chunkSize, 'ascii').get(buf, off);
    }
}
}),
"[project]/node_modules/music-metadata/lib/wav/WaveChunk.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class WaveContentError extends (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$ParseError$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeUnexpectedFileContentError"])('Wave') {
}
const WaveFormat = {
    PCM: 0x0001,
...
class Format {
    ...
    get(buf, off) {
        return {
            wFormatTag: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT16_LE"].get(buf, off),
            nChannels: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT16_LE"].get(buf, off + 2),
            nSamplesPerSec: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_LE"].get(buf, off + 4),
            nAvgBytesPerSec: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_LE"].get(buf, off + 8),
            nBlockAlign: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT16_LE"].get(buf, off + 12),
            wBitsPerSample: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT16_LE"].get(buf, off + 14)
        };
    }
}
class FactChunk {
    ...
    get(buf, off) {
        return {
            dwSampleLength: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_LE"].get(buf, off)
        };
    }
}
}),
...
"[project]/node_modules/music-metadata/lib/wav/BwfChunk.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const BroadcastAudioExtensionChunk = {
    ...
    get: (uint8array, off)=>{
        return {
            description: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripNulls"])(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StringType"](256, 'ascii').get(uint8array, off)).trim(),
            originator: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripNulls"])(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StringType"](32, 'ascii').get(uint8array, off + 256)).trim(),
            originatorReference: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripNulls"])(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StringType"](32, 'ascii').get(uint8array, off + 288)).trim(),
            originationDate: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripNulls"])(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StringType"](10, 'ascii').get(uint8array, off + 320)).trim(),
            originationTime: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripNulls"])(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StringType"](8, 'ascii').get(uint8array, off + 330)).trim(),
            timeReferenceLow: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_LE"].get(uint8array, off + 338),
            timeReferenceHigh: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_LE"].get(uint8array, off + 342),
            version: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT16_LE"].get(uint8array, off + 346),
            umid: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Uint8ArrayType"](64).get(uint8array, off + 348),
            loudnessValue: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT16_LE"].get(uint8array, off + 412),
            maxTruePeakLevel: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT16_LE"].get(uint8array, off + 414),
            maxMomentaryLoudness: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT16_LE"].get(uint8array, off + 416),
            maxShortTermLoudness: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT16_LE"].get(uint8array, off + 418)
        };
    }
};
}),
"[project]/node_modules/music-metadata/lib/wav/WaveParser.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/token-types/lib/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$debug$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/debug/src/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$riff$2f$RiffChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/music-metadata/lib/riff/RiffChunk.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$wav$2f$WaveChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/music-metadata/lib/wav/WaveChunk.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$wav$2f$BwfChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/music-metadata/lib/wav/BwfChunk.js [app-route] (ecmascript)");
;
;
;
;
...
;
;
const debug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$debug$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])('music-metadata:parser:RIFF');
class WaveParser extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$BasicParser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BasicParser"] {
    constructor(){
        super(...arguments);
        this.blockAlign = 0;
    }
    async parse() {
        const riffHeader = await this.tokenizer.readToken(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$riff$2f$RiffChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Header"]);
    ...
    async parseRiffChunk(chunkSize) {
        ...
        switch(type){
            case 'WAVE':
                return this.readWaveChunk(chunkSize - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$FourCC$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FourCcToken"].len);
            default:
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$wav$2f$WaveChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WaveContentError"](`Unsupported RIFF format: RIFF/${type}`);
        }
    }
    async readWaveChunk(remaining) {
        while(remaining >= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$riff$2f$RiffChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Header"].len){
            const header = await this.tokenizer.readToken(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$riff$2f$RiffChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Header"]);
            remaining -= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$riff$2f$RiffChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Header"].len + header.chunkSize;
            ...
            switch(header.chunkID){
                ...
                case 'fact':
                    ...
                    this.fact = await this.tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$wav$2f$WaveChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FactChunk"](header));
                    break;
                case 'fmt ':
                    {
                        const fmt = await this.tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$wav$2f$WaveChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Format"](header));
                        let subFormat = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$wav$2f$WaveChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WaveFormatNameMap"][fmt.wFormatTag];
                        if (!subFormat) {
                ...
                case 'ID3 ':
                    {
                        ...
                        const rst = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$strtok3$2f$lib$2f$core$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fromBuffer"](id3_data);
                ...
                case 'bext':
                    {
                        const bext = await this.tokenizer.readToken(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$wav$2f$BwfChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BroadcastAudioExtensionChunk"]);
                        Object.keys(bext).forEach((key)=>{
                            this.metadata.addTag('exif', `bext.${key}`, bext[key]);
                        });
                        const bextRemaining = header.chunkSize - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$wav$2f$BwfChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BroadcastAudioExtensionChunk"].len;
    ...
    async parseListTag(listHeader) {
        const listType = await this.tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StringType"](4, 'latin1'));
    ...
    async parseRiffInfoTags(chunkSize) {
        while(chunkSize >= 8){
            const header = await this.tokenizer.readToken(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$riff$2f$RiffChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Header"]);
            const valueToken = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$riff$2f$RiffChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ListInfoTagValue"](header);
            const value = await this.tokenizer.readToken(valueToken);
            this.addTag(header.chunkID, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripNulls"](value));
            chunkSize -= 8 + valueToken.len;
        }
        if (chunkSize !== 0) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$wav$2f$WaveChunk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WaveContentError"](`Illegal remaining size: ${chunkSize}`);
        }
    }
    addTag(id, value) {
...
//# sourceMappingURL=node_modules_music-metadata_lib_fe04e68c._.js.map